...
return [
    ...
    'bad_request' => '您的請求還有其他問題，例如您的請求主體為空。',
    ...
    'secret_invalid'       => '您提供的 API 金鑰無效。',
    'secret_missing' => '您忘記加入解決方案參數。',
    'size'                 => [
    ...
    'solution_invalid' => '您提供的解決方案無效（可能是使用者試圖篡改謎題）。',
    'solution_missing' => '您忘記加入密鑰（=API 金鑰）參數。',
    'solution_timeout_or_duplicate' => '該解決方案所對應的謎題已過期或已被使用。',
